...
def main():
    ...
    travel_duration = 0.2  # time to travel to new location
    travel_duration = 1.5  # time to travel to new location

    # Set target offset for second location (relative)
    second_location_offset = (1, 1)  # 0.5m forward, 0.5m right
    #third_hover_duration = (, 1)  # time to hover at new location
